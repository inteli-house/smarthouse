...
static int histeresis = 5;
static int lastHisteresis = 5;
static int setPoint = 220;
static int lastSetPoint = 220;
static int tempOffset = 0;
static int lastTempOffset = 0;
static bool heatEnabled = false;
static bool tempInvert = false;
static int modeAgregate = 0;
static int lastModeAgregate = 0;
static bool heatOn = false;
static bool lastheatOn = false;
static int temperature;
static bool out1, out2, out3, out4, out5, out6, out7, out8;
static int analog1;
static int analog2;
static int analog3;
static int analog4;
static bool digitalInp1, digitalInp2, digitalInp3, digitalInp4, digitalInp5, digitalInp6, digitalInp7, digitalInp8;
